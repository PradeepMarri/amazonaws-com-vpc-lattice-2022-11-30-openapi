...
func ListlistenersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/services/%s/listeners%s", cfg.BaseURL, serviceIdentifier, queryString)
		...
		var result models.ListListenersResponse
...
func CreateListlistenersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_services_serviceIdentifier_listeners",
		mcp.WithDescription("Lists the listeners for the specified service."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListlistenersHandler(cfg),
	}
}
