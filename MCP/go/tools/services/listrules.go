...
func ListrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/services/%s/listeners/%s/rules%s", cfg.BaseURL, listenerIdentifier, serviceIdentifier, queryString)
...
func CreateListrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_services_serviceIdentifier_listeners_listenerIdentifier_rules",
		mcp.WithDescription("Lists the rules for the listener."),
