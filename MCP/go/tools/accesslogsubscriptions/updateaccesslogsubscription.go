...
func UpdateaccesslogsubscriptionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateAccessLogSubscriptionResponse
...
func CreateUpdateaccesslogsubscriptionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_accesslogsubscriptions_accessLogSubscriptionIdentifier",
		mcp.WithDescription("Updates the specified access log subscription."),
		...
		mcp.WithString("destinationArn", mcp.Required(), mcp.Description("Input parameter: The Amazon Resource Name (ARN) of the access log destination.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdateaccesslogsubscriptionHandler(cfg),
	}
}
