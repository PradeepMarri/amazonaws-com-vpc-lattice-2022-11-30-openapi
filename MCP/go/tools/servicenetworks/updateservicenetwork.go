...
func UpdateservicenetworkHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateServiceNetworkResponse
...
func CreateUpdateservicenetworkTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_servicenetworks_serviceNetworkIdentifier",
		mcp.WithDescription("Updates the specified service network."),
