...
func GettargetgroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetTargetGroupResponse
...
func CreateGettargetgroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_targetgroups_targetGroupIdentifier",
		mcp.WithDescription("Retrieves information about the specified target group."),
		mcp.WithString("targetGroupIdentifier", mcp.Required(), mcp.Description("The ID or Amazon Resource Name (ARN) of the target group.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GettargetgroupHandler(cfg),
	}
}
